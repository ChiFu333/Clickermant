...
namespace SFH {
    ...
    public static class SceneSelectionToolbar {
        ...
        static SceneSelectionToolbar() {
            ...
            SetOpenedScene(EditorSceneManager.GetActiveScene());
        }
        ...
        static void OnToolbarGUI() {
            ...
            if (GUI.changed && _selectedIndex > 0 && _scenes.Count > _selectedIndex - 1) {
                if (_sceneOpened == _scenes[_selectedIndex - 1]) {
                    return;
                }
        ...
        static void TryOpenScene() {
            try {
                EditorSceneManager.OpenScene(_scenes[_selectedIndex - 1].Path);
            } catch {
                _scenes.RemoveAt(_selectedIndex - 1);
                _selectedIndex = _scenes.Count - 1;
